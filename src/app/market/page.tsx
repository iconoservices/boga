...
// Contenido curado del home (aún sin tabla propia en Supabase). Se edita a mano
// hasta que exista un panel para itinerarios / lista VIP / tiendas verificadas.

// 1. Itinerarios y experiencias — "¿Qué hacer en Pucallpa hoy?"
const EXPERIENCES = [
...
// 2. Comida — lista VIP de restaurantes (posición pagada por el local)
...
// 3. Tus tiendas / arbitraje — "Compra seguro"
const SAFE_DEALS = [
...
// 4. Notas / contenido editorial — "Yo Soy de la Selva"
const SELVA_NOTES = [
      ...
      <main className="max-w-[1440px] mx-auto w-full flex flex-col gap-4 lg:gap-6 mt-4 lg:mt-5 pb-12">
        ...
        {activeCategory === 'Todas' ? (
          <div className="flex flex-col gap-6 lg:gap-8 px-container-margin lg:px-6">
            ...
            {/* Tablero local de chamba y servicios — Yapu Point */}
            <Link
              href="/explore"
            ...
            >
              ...
              <div className="relative flex flex-col min-w-0 flex-1">
                ...
                <span className="text-inverse-on-surface/70 font-body-md text-xs mt-0.5">Entra al tablero local · Yapu Point</span>
              </div>
            ...
            <section className="flex flex-col gap-4">
              <div className="flex justify-between items-end mb-1">
                ...
                <Link href="/explore" className="text-primary font-label-md text-sm shrink-0">Ver todo</Link>
              </div>
