...
// Landing B2B: la puerta de entrada para dueños de negocio, separada del
// Marketplace (/market) que es para el consumidor final. No mezclar "cómprame
// el software" con "quiero pedir un pollo" en la misma pantalla — cada quien
// entra por su puerta.
