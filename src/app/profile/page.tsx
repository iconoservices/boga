...
export default function ProfilePage() {
  ...
  return (
    <>
      ...
      <div style={{ minHeight: '100vh', backgroundColor: '#f8f9fa', fontFamily: ff }}>
        ...
        <header style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            <Link href="/explore" style={{ display: 'flex', alignItems: 'center', textDecoration: 'none' }}>
              <div style={{ width: '32px', height: '32px', backgroundColor: '#000', borderRadius: '9px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                <span style={{ color: '#fff', fontWeight: 900, fontSize: '16px' }}>B</span>
              </div>
              <span style={{ marginLeft: '8px', fontWeight: 800, fontSize: '16px', color: '#111', letterSpacing: '-0.02em' }}>Boga</span>
            </Link>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            <Link href="/explore" style={{ textDecoration: 'none', color: '#666', fontSize: '13px', fontWeight: 600 }}>
              Explorar
            </Link>
            <div style={{ width: '36px', height: '36px', borderRadius: '50%', backgroundColor: '#111', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <span style={{ color: '#fff', fontWeight: 800, fontSize: '13px' }}>{initials}</span>
            </div>
          </div>
        </header>
        ...
        <nav style={{
          ...
          {[
            ...
            { href: '/profile', icon: 'person', label: 'Perfil', active: true },
