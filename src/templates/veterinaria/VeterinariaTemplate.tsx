...
/**
 * Plantilla "Veterinaria": base de Ficha Plana (portada, ficha del local, catálogo,
 * pedido por WhatsApp) + pestaña "Cartilla" con el carné de vacunación digital y
 * semáforo de vencimientos. Por ahora la cartilla es de ejemplo (Firulais); la
 * carga real de mascotas por veterinaria es la fase 2.
 *
 * Base heredada de Ficha Plana:
    ...
    <div className="min-h-screen" style={{ background: t.background, color: t.onBackground, fontFamily: t.fontBody }}>
      ...
      <main className="pt-16 md:pt-[60px] pb-24 md:pb-12">
        ...
        {activeTab === 'menu' && (
          <div className="animate-fade-in">
            <div className="px-5 md:px-6 pt-6 pb-2">
              <h2 className="font-black text-2xl md:text-3xl" style={{ color: t.onBackground }}>Nuestra tienda</h2>
            </div>
        ...
        {activeTab === 'cartilla' && (
          <CartillaMascota
            t={t}
            veterinaria={store.name}
            onCita={(msg) => enviarPedidoPorWhatsApp(store, msg)}
          />
        )}
        ...
        <StoreFooter
          ...
          acciones={[
            ...
            { icon: 'storefront', label: 'Tienda', onClick: () => navToMenu() },
      ...
      <BottomNav
        ...
        tabs={[
          ...
          { id: 'cartilla', icon: 'vaccines', label: 'Cartilla' },
