...
const TEMPLATES: Record<string, TemplateConfig> = {
  ...
  veterinaria: {
    ...
    heroAlt: 'Perro en la veterinaria',
    theme: {
      primary: '#0f8f7e',
      onPrimary: '#ffffff',
      primaryContainer: '#0a6357',
      secondary: '#4a6360',
      secondaryContainer: '#d5ece8',
      background: '#f4faf9',
      surface: '#ffffff',
      surfaceContainer: '#e8f4f2',
      surfaceContainerLow: '#f4faf9',
      surfaceContainerLowest: '#ffffff',
      surfaceContainerHigh: '#dcedea',
      onBackground: '#10231f',
      onSurface: '#10231f',
      onSurfaceVariant: '#456560',
      outlineVariant: '#c5dcd8',
      fontHeadline: "'Plus Jakarta Sans', sans-serif",
      fontBody: "'Plus Jakarta Sans', sans-serif",
      fontLabel: "'Plus Jakarta Sans', sans-serif",
    },
    categories: [
      { name: 'Alimento', icon: 'pet_supplies', href: 'alimento' },
      { name: 'Accesorios', icon: 'pets', href: 'accesorios' },
      { name: 'Higiene', icon: 'bathtub', href: 'higiene' },
      { name: 'Servicios', icon: 'medical_services', href: 'servicios' },
    ],
    demoProducts: [
      { name: 'Alimento para perro adulto 3kg', price: 65.00, category: 'Alimento', image: 'https://images.unsplash.com/photo-1589924691995-400dc9ecc119?w=400&q=80', description: 'Croquetas balanceadas' },
      { name: 'Correa y collar', price: 28.00, category: 'Accesorios', image: 'https://images.unsplash.com/photo-1601758124510-52d02ddb7cbd?w=400&q=80', description: 'Ajustable, varios tamaños' },
      { name: 'Shampoo antipulgas', price: 24.00, category: 'Higiene', image: 'https://images.unsplash.com/photo-1583512603805-3cc6b41f3edb?w=400&q=80', description: 'Uso semanal, pelaje suave' },
      { name: 'Baño y corte', price: 40.00, category: 'Servicios', image: 'https://images.unsplash.com/photo-1516734212186-a967f81ad0d7?w=400&q=80', description: 'Reserva por WhatsApp' },
    ],
    zona: 'Pucallpa - Ucayali',
    direccion: 'Jr. Ucayali 123',
  ...
  terreno1: {
    ...
    heroAlt: 'Terreno para la venta',
    theme: {
      primary: '#f5a623',
      onPrimary: '#1b2a4a',
      primaryContainer: '#c98410',
      secondary: '#3d4b6b',
      secondaryContainer: '#dde3f2',
      background: '#f6f7fb',
      surface: '#ffffff',
      surfaceContainer: '#eceff6',
      surfaceContainerLow: '#f6f7fb',
      surfaceContainerLowest: '#ffffff',
      surfaceContainerHigh: '#e1e6f1',
      onBackground: '#1b2a4a',
      onSurface: '#1b2a4a',
      onSurfaceVariant: '#5b6785',
      outlineVariant: '#dfe3ee',
      fontHeadline: "'Plus Jakarta Sans', sans-serif",
      fontBody: "'Plus Jakarta Sans', sans-serif",
      fontLabel: "'Plus Jakarta Sans', sans-serif",
    },
    categories: [
      { name: 'Yarinacocha', icon: 'landscape', href: 'yarinacocha' },
      { name: 'Callería', icon: 'landscape', href: 'calleria' },
      { name: 'Manantay', icon: 'landscape', href: 'manantay' },
      { name: 'Campo Verde', icon: 'landscape', href: 'campo-verde' },
    ],
    demoProducts: [
      { name: 'Lote 200 m² con título', price: 45000, category: 'Yarinacocha', image: 'https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=800&q=80', description: 'Esquina, agua y luz cerca, a 5 min de la laguna' },
      { name: 'Terreno 10 x 20 m', price: 38000, category: 'Callería', image: 'https://images.unsplash.com/photo-1441974231531-c6227db76b6e?w=800&q=80', description: 'Plano, listo para construir' },
      { name: 'Lote 300 m² frente a pista', price: 62000, category: 'Manantay', image: 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=800&q=80', description: 'Ideal para local comercial' },
      { name: 'Chacra 1 hectárea', price: 90000, category: 'Campo Verde', image: 'https://images.unsplash.com/photo-1560518883-ce09059eeffa?w=800&q=80', description: 'Con acceso por carretera, apta para cultivo' },
    ],
    zona: 'Pucallpa - Ucayali',
    direccion: 'Jr. Ucayali 123',
  ...
  terreno2: {
    ...
    theme: {
      primary: '#ff6a00',
      onPrimary: '#ffffff',
      primaryContainer: '#c95300',
      secondary: '#5a5240',
      secondaryContainer: '#ebe5d3',
      background: '#f8f6f1',
      surface: '#ffffff',
      surfaceContainer: '#efeadd',
      surfaceContainerLow: '#f8f6f1',
      surfaceContainerLowest: '#ffffff',
      surfaceContainerHigh: '#e6e0d0',
      onBackground: '#2a2418',
      onSurface: '#2a2418',
      onSurfaceVariant: '#6b6250',
      outlineVariant: '#e2ddd0',
      fontHeadline: "'Plus Jakarta Sans', sans-serif",
      fontBody: "'Plus Jakarta Sans', sans-serif",
      fontLabel: "'Plus Jakarta Sans', sans-serif",
    },
