...
const anexoMarket: DocLegal = {
  ...
  secciones: [
    ...
    },
    {
      ...
      bloques: [
        { tipo: 'p', texto: 'Cuando Boga o un comercio ofrezcan planes de comida (por ejemplo un pack semanal de almuerzos de Pensión), antes de contratar vas a ver: qué incluye, el precio, cada cuánto se cobra y cómo se renueva.' },
        { tipo: 'lista', items: [
        ...
        { tipo: 'p', texto: 'Boga puede modificar o descontinuar un plan avisando con la misma anticipación; si queda saldo a favor tuyo, se te reembolsa o se te acredita en Boga Points, a tu elección.' },
      ],
    },
  ],
};
