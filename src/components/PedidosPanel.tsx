...
// Pedidos + Me gusta (favoritos). Se usa como pestaña "Pedidos" del perfil y
// también en /orders. Los favoritos viven en localStorage; el pedido activo y el
// historial todavía son de muestra (no hay tabla de pedidos conectada).
